...
function App() {
  ...
  const [isChordClicked, setIsChordClicked] = useState(true); // To 
          ...
          return (
            <g key={circleIndex}>
              ...
              {circle.chords.map((chord, index) => {
                ...
                const isClicked = pianoSound&&clickedSegment?.circleIndex === circleIndex && clickedSegment?.chordIndex === index;
